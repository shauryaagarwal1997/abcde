...
if(appState===1){    
    ...
    textSize(45);
    fill("yellow");
    text("LONGITUDE :",displayWidth/2-30,displayHeight/2-290);
    text("LATITUDE :",displayWidth/2-30,displayHeight/2-210);
    text("HEMISPHERE (E/W) :",displayWidth/2-30,displayHeight/2-130);
    text("HEMISPHERE (N/S) :",displayWidth/2-30,displayHeight/2-50);
    text("CONTINENT :",displayWidth/2-30,displayHeight/2+30);
    text("ALTITUDE :",displayWidth/2-30,displayHeight/2+110);
    text("SPEED :",displayWidth/2-30,displayHeight/2+190);
    text("DAY / NIGHT :",displayWidth/2-30,displayHeight/2+270);
    text("km",displayWidth/2+420,displayHeight/2+110);
    text("km/hr",displayWidth/2+420,displayHeight/2+190);

    textSize(47);
    fill("red");
    text(dataInfoA1,displayWidth/2+280,displayHeight/2-290);
    text(dataInfoB1,displayWidth/2+250,displayHeight/2-210);
    text(dataInfoC1,displayWidth/2+230,displayHeight/2+110);
    text(dataInfoD1,displayWidth/2+180,displayHeight/2+190);

    if(hello5==="-"){
        text("WESTERN",displayWidth/2+435,displayHeight/2-120);
    }else{
        text("EASTERN",displayWidth/2+435,displayHeight/2-130);
    }
    if(hello6==="-"){
        text("SOUTHERN",displayWidth/2+435,displayHeight/2-50);
    }else{
        text("NORTHERN",displayWidth/2+435,displayHeight/2-50);
    }

    if(day==="daylight"){
        text("DAY",displayWidth/2+290,displayHeight/2+270);
    }else{
        text("NIGHT",displayWidth/2+290,displayHeight/2+270);
    }

    if(dataInfoA>60 && dataInfoA<120 && dataInfoB>10 && dataInfoB<80){
        text("ASIA",displayWidth/2+290,displayHeight/2+30);
    }else{
    }
    ...
    if(dataInfoA>15 && dataInfoA<45 && dataInfoB<10 && dataInfoB>-35){
        text("AFRICA",displayWidth/2+290,displayHeight/2+30);
    }else{
    }
    ...
    if(dataInfoA>113 && dataInfoA<153 && dataInfoB<-10 && dataInfoB>-40){
        text("AUSTRALIA",displayWidth/2+290,displayHeight/2+30);
    }else{
    }


    if(dataInfoA>-8 && dataInfoA<45 && dataInfoB>40 && dataInfoB<70){
        text("EUROPE",displayWidth/2+290,displayHeight/2+30);
    }else{
    }

    if(dataInfoA>-130 && dataInfoA<-60 && dataInfoB<70 && dataInfoB>15){
        text("NORTH AMERICA",displayWidth/2+290,displayHeight/2+30);
    }else{
    }

    if(dataInfoA<-52 && dataInfoA>-75 && dataInfoB>0 && dataInfoB<8){
        text("SOUTH AMERICA",displayWidth/2+290,displayHeight/2+30);
    }else{
    }
